...
class _BottleScreenState extends State<BottleScreen> {
                        ...
                        children: [
                          ...
                          Container(
                            ...
                            child: CustomButon(
                                onPress: () {
                                  var d =
                                  filterBottleList(_searchControlloer.text);
                                  setState(() {
                                    bottleList = d;
                                  });
                                },
                    ...
                    children: [
                        ...
                        Column(
                          children: [
                              ...
                              child: Row(
                                ...
                                children: [
                                  ...
                                  Container(
                                      ...
                                      child: Text(" No Bouteille " ,style: boldTextStyle(color: Colors.white))),
                                  Container(
                                      width: context.width()/7,
                                      child: Text("No serie",style: boldTextStyle(color: Colors.white))),
                                  Container(
                                      width: context.width()/7,
                                      child: Text("Designation",style: boldTextStyle(color: Colors.white))),
                                  Container(
                                      width: context.width()/7,
                                      child: Text("Statut",style: boldTextStyle(color: Colors.white),)),
                            ...
                            ListView.builder(
                                ...
                                itemCount: bottleList!.length>9 ?9:bottleList!.length,
                                    ...
                                    children: [
                                      ...
                                      ListTile(
                                        ...
                                        title: Row(
                                          ...
                                          children: [
                                            Container(
                                                ...
                                                child: Text(" ${itemIndex+1} - "+bottleList![itemIndex].nbBottle)),
                                            Container(
                                                width: context.width()/7,
                                                child: Text(bottleList![itemIndex].nbBottle)),
                                            Container(
                                                width: context.width()/7,
                                                child: Text(bottleList![itemIndex].nbBottle)),
                                            Container(
                                                width: context.width()/7,
                                                child: Text(bottleList![itemIndex].localisation)),
                                        ...
                                        trailing: Row(
                                          ...
                                          children: [
                                            Icon(Icons.edit)
                                            .onTap(()=>_showEditBottleDialog(context,bottleList![itemIndex])),
                                            SizedBox(width: 20,),
                                            Icon(Icons.delete_forever,color: Colors.red,)
                                            .onTap(()=>_showDeleteBottleDialog(context,bottleList![itemIndex]))
                                          ],
                                        ),
                                      ),
                                    ],
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          SizedBox(width: 16.0),
                          Text("Page $_currentPage/${(bottleList!.length/_itemsPerPage).ceil()}"),
                          SizedBox(width: 16.0),
                          ElevatedButton(
  ...
  void _previousPage() {
    ...
    setState(() {
      if(_currentPage >=2 && _currentPage<=(bottleList!.length/_itemsPerPage).ceil()){
        _currentPage--;
  ...
  Future<void> _showDeleteBottleDialog(BuildContext context, Bottle bottle) async {
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          ...
          content: SingleChildScrollView(
            child: ListBody(
              children: <Widget>[
                Text('Êtes-vous sûr de vouloir supprimer la bouteille ${bottle.nbBottle} ?'),
              ],
            ),
          ),
          actions: <Widget>[
              ...
              child: Column(
                ...
                children: [
                  TextFormField(
                    ...
                    decoration: const InputDecoration(labelText: 'Nombre de bouteilles'),
                    validator: (value) {
                  ...
                  DropdownButtonFormField<String>(
                    ...
                    items: [
                      DropdownMenuItem<String>(value: 'Vide', child: Text('Vide')),
                      DropdownMenuItem<String>(value: 'Plein', child: Text('Plein')),
                      DropdownMenuItem<String>(value: 'En production', child: Text('En production')),
                    ],
                  ...
                  TextFormField(
                    ...
                    validator: (value) {
                      if (value == null || value.isEmpty) {
                        return 'Veuillez entrer le rack';
                      }
                      return null;
                    },
                  ),
  ...
  Future<void> _showEditBottleDialog(BuildContext context, Bottle bottle) async {
    final _formKey = GlobalKey<FormState>();
    ...
    void _submitForm() {
      if (_formKey.currentState!.validate()) {
        ...
        print(_nbBottleController);
        print(_rackController);
        // Close the dialog
        Navigator.of(context).pop();
      }
    }
